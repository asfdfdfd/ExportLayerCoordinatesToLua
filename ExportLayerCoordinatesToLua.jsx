...
var fileName = docRef.name.substring (0, docRef.name.length - 4);

str = fileName + "={\n";
str += "    width=" + docWidth + ",\n";
str += "    height=" + docHeight + ",\n";
str += "    layers={\n";
...
// str += str2.toString();
    ...
    var str2 = "        "+layerName + "={\n";
    str2 += "            stack=" + (i-1) + ",\n";
    str2 += "            position={"+leftTop+"},\n";
    str2 += "            size={"+layerData.layerWidth+", " + layerData.layerHeight + "},\n";
    str2 += "            transformpoint=\"center\"\n";
    str2 += "        },\n";
